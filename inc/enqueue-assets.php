...
function jld_enqueue_assets() {
    ...
    if (is_singular('project')) {
        wp_enqueue_style('lightbox-css', JLD_THEME_URL . '/assets/css/lightbox.min.css', array(), JLD_VERSION);
        wp_enqueue_script('lightbox-js', JLD_THEME_URL . '/assets/js/lightbox.min.js', array('jquery'), JLD_VERSION, true);
    }
}
/**
